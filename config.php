<?php 
	$mysqllogin = 'root'; //Логин базы данных mysql
	...
	$kfloyalgame = 2; // Коефициент перевода денег в игровые баллы при выигрыше в казино
	$kfloyal = 1; // Коефициент перевода денег в игровые баллы при пополнении казино
	session_start();
 ?>